...
int input_read_parameters_species(struct file_content * pfc,
  ...
  if (pba->Omega0_fld != 0.) {
    ...
    if (flag1 == _TRUE_) {
      ...
      else if ((strstr(string1,"JJE") != NULL) || (strstr(string1,"jje") != NULL)) {
        pba->fluid_equation_of_state = JJE;
      }
      else if ((strstr(string1,"LINEAL") != NULL) || (strstr(string1,"lineal") != NULL)) {
        pba->fluid_equation_of_state = LINEAL;
      }
    ...
    if (pba->fluid_equation_of_state == JJE) {
      /** 8.a.2.4) Equation of state of the fluid in 'JJE' case */
      /* Read */
      class_read_double("w0_0",pba->w0_0);
      class_read_double("w0_1",pba->w0_1);
      class_read_double("w0_2",pba->w0_2);
      class_read_double("w0_3",pba->w0_3);
    }
    if (pba->fluid_equation_of_state == LINEAL) {
      /** 8.a.2.5) Equation of state of the fluid in 'LINEAL' case */
      /* Read */
      class_read_double("w0_lin1",pba->w0_lin1);
      class_read_double("w0_lin2",pba->w0_lin2);
    }
    if (pba->fluid_equation_of_state == BA) {
      /** 8.a.2.6) Equation of state of the fluid in 'BA' case */
      /* Read */
      class_read_double("w0_ba1",pba->w0_ba1);
      class_read_double("w0_ba2",pba->w0_ba2);
    }
  }
