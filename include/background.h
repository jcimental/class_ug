...
enum equation_of_state {CLP,EDE,JJE};
...
struct background
{
  ...
  double Omega0_efld; /**< as an excercise, add a new fluid*/
  double w0_efld;

  double w0_0;  /** fluid equation for JJE model */
  double w0_1;
  double w0_2;
  double w0_3;
  ...
  int index_bi_rho_efld; /**<{B} extra fluid density */
